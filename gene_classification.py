...
def train_model(models, dataloads, scheduler,criterion=None,history=None,num_epochs=100,board=None,
    ...
    for epoch in range(start_epoch,num_epochs):
        ...
        global train_index
        global val_index
        train_index=random.randint(0, 3)
        val_index=random.randint(3,5)
...
def main():
    ...
    data_loader = {'train':DataLoader(train_dataset,batch_size=16,shuffle=False,num_workers=64),'val':DataLoader(test_dataset,batch_size=16,shuffle=False,num_workers=64)}
